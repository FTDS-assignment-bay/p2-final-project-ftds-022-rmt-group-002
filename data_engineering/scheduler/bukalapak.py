...
def webscrap_bukalapak():
    ...
    for i in range(1,4):
        ...
        url = "https://www.bukalapak.com/products?page={}&search%5Bkeywords%5D=emas%20antam%201%20gram".format(i)
        driver.get(url)
...
def clean_bukalapak():
    ...
    early_file_name = 'BukalapakMas_clean_early.csv'
    latest_file_name = 'BukalapakMas_clean_latest.csv'
